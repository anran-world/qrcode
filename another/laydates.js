; !function () {
  ...
  var e = window.layui && layui.define
      ...
      , o = "layui-this"
      , s = "laydate-disabled"
      , l = "寮€濮嬫棩鏈熻秴鍑轰簡缁撴潫鏃ユ湡<br>寤鸿閲嶆柊閫夋嫨"
      , d = [100, 2e5]
  ...
  C.prototype = [],
              ...
              w(d).html(function () {
                  ...
                  return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + n.timeTips + "</span>"),
                      w.each(t.btns, function (e, r) {
                          var o = n.tools[r] || "btn";
                          t.range && "now" === r || (a && "clear" === r && (o = "cn" === t.lang ? "閲嶇疆" : "Reset"),
              ...
              i) : (l = l || r.value,
                  ...
                  "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "),
                      ...
                      w.each([i.startDate, i.endDate], function (e, t) {
                          m(t, l[e], e)
                      })) : m(o, l) : (i.hint("鏃ユ湡鏍煎紡涓嶅悎娉�<br>蹇呴』閬靛惊涓嬭堪鏍煎紡锛�<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>宸蹭负浣犻噸缃�"),
      ...
      T.prototype.calendar = function (e) {
          ...
          if (l.year < d[0] && (l.year = d[0],
              r.hint("鏈€浣庡彧鑳芥敮鎸佸埌鍏厓" + d[0] + "骞�")),
              l.year > d[1] && (l.year = d[1],
                  r.hint("鏈€楂樺彧鑳芥敮鎸佸埌鍏厓" + d[1] + "骞�")),
              ...
              "cn" === s.lang ? (w(f[0]).attr("lay-type", "year").html(l.year + "骞�"),
                  w(f[1]).attr("lay-type", "month").html(l.month + 1 + "鏈�")) : (w(f[0]).attr("lay-type", "month").html(m.month[l.month]),
              ...
              u && (s.range && (e ? r.endDate = r.endDate || {
                  ...
                  e && (r.listYM = [[r.startDate.year, r.startDate.month + 1], [r.endDate.year, r.endDate.month + 1]],
                      ...
                      "time" === s.type ? r.setBtnStatus("鏃堕棿", w.extend({}, r.systemDate(), r.startTime), w.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))),
      ...
      T.prototype.setBtnStatus = function (e, t, n) {
          ...
          d && (t = t || i.startDate,
              ...
              e && a && i.hint("string" == typeof e ? l.replace(/鏃ユ湡/g, e) : l))
      }
      ,
          ...
          var n = this
              ...
              , o = {
                  ...
                  confirm: function () {
                      if (a.range) {
                          if (!n.endDate)
                              return n.hint("璇峰厛閫夋嫨鏃ユ湡鑼冨洿");
                          if (w(e).hasClass(s))
                              return n.hint("time" === a.type ? l.replace(/鏃ユ湡/g, "鏃堕棿") : l)
                      } else if (w(e).hasClass(s))
                          return n.hint("涓嶅湪鏈夋晥鏃ユ湡鎴栨椂闂磋寖鍥村唴");
                      n.done(),
                          n.setValue(n.parse()).remove()
                  }
              };
